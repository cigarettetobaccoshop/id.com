...
export const warehouseFooterStyles = `
  .r2-hp-final-location.is-relocated-to-footer{
    display:none!important;
  }
  .r2-hp-final-footer-map-slot{
    grid-column:1/-1;
    min-width:0;
    width:100%;
  }
  .r2-hp-final-footer-warehouse{
    display:grid;
    ...
    box-shadow:0 20px 55px rgba(0,0,0,.18),inset 0 1px 0 rgba(255,255,255,.07);
    overflow:hidden;
  }
  .r2-hp-final-footer-warehouse-copy{
    min-width:0;
    display:flex;
  ...
  .r2-hp-final-footer-kicker{
    font-size:7px;
    letter-spacing:.2em;
    font-weight:950;
    color:#9fc5ff;
  }
  .r2-hp-final-footer-warehouse-copy h2{
    margin:12px 0 12px;
    color:#fff;
  ...
  .r2-hp-final-footer-warehouse-copy h2 em{
    color:#e4c27e;
    font-style:normal;
  }
  .r2-hp-final-footer-warehouse-copy>p{
    margin:0;
    max-width:500px;
  ...
  .r2-hp-final-footer-hours>span{
    width:28px;
    height:28px;
    display:grid;
    place-items:center;
    border:1px solid rgba(159,197,255,.2);
    border-radius:9px;
    background:rgba(159,197,255,.08);
    color:#9fc5ff;
    font-size:18px;
  }
  .r2-hp-final-footer-hours strong{
    display:grid;
    gap:3px;
    font-size:9px;
    letter-spacing:.02em;
  }
  .r2-hp-final-footer-hours b{
    color:#fff;
    font-size:10px;
  }
  .r2-hp-final-footer-location-link{
    align-self:flex-start;
    margin-top:18px;
    padding:10px 13px;
    border:1px solid rgba(159,197,255,.22);
    border-radius:10px;
    background:rgba(31,120,232,.14);
  ...
  .r2-hp-final-footer-location-link:hover{
    transform:translateY(-2px);
    background:rgba(31,120,232,.24);
    border-color:rgba(159,197,255,.4);
  }
  .r2-hp-final-footer-map-wrap{
    min-width:0;
    border:1px solid rgba(148,163,184,.18);
    border-radius:20px;
    background:rgba(4,17,36,.28);
    overflow:hidden;
  }
  .r2-hp-final-footer-map-head{
    display:flex;
    align-items:center;
  ...
  @media (max-width:900px){
    .r2-hp-final-footer-warehouse{grid-template-columns:1fr;gap:16px}
    .r2-hp-final-footer-map-slot{max-width:none;justify-self:stretch}
    .r2-hp-final-footer-map-frame{height:170px}
  }
  @media (max-width:620px){
    .r2-hp-final-footer-warehouse{grid-template-columns:1fr;padding:14px;border-radius:20px;gap:12px}
    .r2-hp-final-footer-warehouse-copy{padding:5px 3px 3px}
    .r2-hp-final-footer-warehouse-copy h2{font-size:27px;margin:10px 0 10px}
    .r2-hp-final-footer-warehouse-copy>p{font-size:10px;line-height:1.55}
    .r2-hp-final-footer-hours{margin-top:14px}
    .r2-hp-final-footer-location-link{margin-top:13px}
    .r2-hp-final-footer-map-frame{height:155px}
  }
  @media (prefers-reduced-motion:reduce){
    .r2-hp-final-footer-map-head i b,.r2-hp-final-footer-location-link,.r2-hp-final-footer-map-open{animation:none;transition:none}
  }
`
