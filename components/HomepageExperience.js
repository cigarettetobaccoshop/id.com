...
// Generic, unbranded cigarette photography from Wikimedia Commons.
// Keep a local SVG fallback so a remote-image outage never renders a broken-image icon.
...
const thumbFallback='data:image/svg+xml;charset=UTF-8,'+encodeURIComponent('<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 960 640"><rect width="960" height="640" fill="#111827"/><circle cx="760" cy="120" r="220" fill="#1f2937"/><path d="M90 470 C280 360 430 360 640 470" fill="none" stroke="#E5C385" stroke-width="10" opacity=".7"/><text x="72" y="165" fill="#E5C385" font-family="Arial,sans-serif" font-size="38" font-weight="700" letter-spacing="7">R2 NUSANTARA</text><text x="72" y="215" fill="#fff" opacity=".72" font-family="Arial,sans-serif" font-size="18" font-weight="700" letter-spacing="5">WHOLESALE TRADING PARTNER</text><text x="72" y="570" fill="#fff" opacity=".45" font-family="Arial,sans-serif" font-size="14" letter-spacing="4">GENERIC PRODUCT VISUAL</text></svg>')
const categories=[
