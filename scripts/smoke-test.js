...
if (!adminOrders.includes('admin_dashboard_snapshot')) throw new Error('Admin monitoring RPC integration missing')
if (!adminOrders.includes('admin_update_order_status')) throw new Error('Admin status RPC integration missing')
